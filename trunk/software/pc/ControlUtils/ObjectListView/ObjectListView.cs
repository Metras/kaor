...
namespace ControlUtils.ObjectListView
{
    /// <summary>
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
    {
            ...
            : base()
        {
			...
			objectsGetterDelegate = DefaultObjectsGetter;
        }

		IEnumerable DefaultObjectsGetter()
		{
			return objects;
		}
        ...
        {
            this.BuildList(true, true);
        }

		virtual public void BuildList(bool shouldPreserveState)
		{
			this.BuildList(shouldPreserveState, true);
		}
        /// <summary>
        /// Build/rebuild all the list view items in the list
        /// </summary>
        ...
        /// </para>
        /// </remarks>
        virtual public void BuildList(bool shouldPreserveState, bool shouldSort)
        {
            if (this.Frozen)
                return;
            ...
            if (this.objects != null) {
				...
				foreach (object rowObject in objectsGetterDelegate())
				{
		...
		[Browsable(false),
		 DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public ObjectsGetterDelegate ObjectsGetter
		{
			get { return objectsGetterDelegate; }
			set
			{
				objectsGetterDelegate = value;
			}
		}
		private ObjectsGetterDelegate objectsGetterDelegate;
	...
	public delegate IEnumerable ObjectsGetterDelegate();
    ...
    /// instead of using the default ToString(CultureInfo.InvariantCulture)
    /// </summary>
    ...
    public partial class OLVColumn : ColumnHeader
    {
        ...
        /// the conversion, otherwise just use ToString(CultureInfo.InvariantCulture). Nulls are always converted
        /// to empty strings.
        /// </remarks>
