...
namespace ZedGraph
{
	...
	#region Button and Key Properties
		...
		public bool IsAutoCursor
		{
			get { return _isAutoCursor; }
			set { _isAutoCursor = value; }
		}
		/// <summary>
	...
	#region Properties
		...
		*/
		...
		/// if it is a <see cref="System.String"/> type, or <see cref="PointPairBase.ToString(CultureInfo.InvariantCulture)"/>
