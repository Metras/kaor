...
namespace ControlUtils.ListViewPrinter
{
    /// <summary>
    ...
    public class ListViewPrinter : ListViewPrinterBase
    {
        ...
        override protected float CalculateRowHeight(Graphics g, ListView lv, int n)
        {
            ...
            if (lv is ControlUtils.ObjectListView.ObjectListView)
				height = Math.Max(height, ((ControlUtils.ObjectListView.ObjectListView)lv).RowHeight);
            return height;
        }
        ...
        {
			if (this.IsTextOnly || !(lv is ControlUtils.ObjectListView.ObjectListView))
			{
			...
			renderer.ListView = (ControlUtils.ObjectListView.ObjectListView)lv;
