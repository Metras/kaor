...
namespace ZedGraph
{
	...
	#region Fields
		...
		protected double _rangeDefault;
		protected Bitmap	_gradientBM;
	...
	#region Methods
		...
		protected virtual Color GetGradientColor( double val )
		{
		...
		protected Brush ScaleBrush( RectangleF rect, Brush brush, bool isScaled )
		{
			if ( brush != null )
			{
