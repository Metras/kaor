...
namespace ZedGraph
{
	...
	#region Member variables
		...
		/// <see cref="ToString(CultureInfo.InvariantCulture)"/> method.
		/// </summary>
	...
	#region Methods
		...
		/// the two double type values (see <see cref="System.Double.ToString(CultureInfo.InvariantCulture)"/>).</param>
		/// <returns>A string representation of the PointPair</returns>
		...
		/// double type value (see <see cref="System.Double.ToString(CultureInfo.InvariantCulture)"/>).</param>
