...
namespace ZedGraph
{
	...
	#region Fields
		...
		internal double _minScrollRange;
		internal double _maxScrollRange;
		internal bool _isLimitMinScrollRange;
		internal bool _isLimitMaxScrollRange;

		/// <summary>
		/// Minimum zoom range
		/// </summary>
		internal double _minRange;
	...
	#region Defaults
		...
		public struct Default
		{
			...
			/// type values, this value is set as per the <see cref="XDate.ToString(CultureInfo.InvariantCulture)"/> function.
			/// </summary>
			...
			/*  Prior format assignments using original XDate.ToString(CultureInfo.InvariantCulture)
	...
	#region constructors
		...
		public Scale( Axis ownerAxis )
		{
			...
			_isLimitMaxScrollRange = false;
			_isLimitMinScrollRange = false;
...
*/
	...
	#region properties
		public bool IsLimitMinScrollRange
		{
			get { return _isLimitMinScrollRange; }
			set { _isLimitMinScrollRange = value; }
		}

		public bool IsLimitMaxScrollRange
		{
			get { return _isLimitMaxScrollRange; }
			set { _isLimitMaxScrollRange = value; }
		}
		public double MinScrollRange
		{
			get { return _minScrollRange; }
			set { _minScrollRange = value; }
		}
		...
		public double MaxScrollRange
		{
			get { return _maxScrollRange; }
			set { _maxScrollRange = value; }
		}
...
*/
		...
		public virtual double Min
		{
			...
			set 
			{
				if (_isLimitMinScrollRange && value < _minScrollRange)
					_min = _minScrollRange;
				else
					_min = value; 
				_minAuto = false; 
		...
		public virtual double Max
		{
			...
			set 
			{
				if (_isLimitMaxScrollRange && value > _maxScrollRange)
					_max = _maxScrollRange;
				else
					_max = value; 
				_maxAuto = false; 
			}
