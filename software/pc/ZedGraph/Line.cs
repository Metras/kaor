...
namespace ZedGraph
{
	...
	#region Fields
		...
		protected float _smoothTension;
		/// <summary>
		...
		/// </summary>
		protected bool _isOptimizedDraw;
	...
	#region Rendering Methods
		...
		/// <param name="curve">A <see cref="LineItem"/> representing this
		/// curve.</param>
		public virtual void DrawCurve( Graphics g, GraphPane pane,
                                CurveItem curve, float scaleFactor )
		{
			Line source = this;
			if ( curve.IsSelected )
		...
		/// </summary>
		protected void InterpolatePoint( Graphics g, GraphPane pane, CurveItem curve, PointPair lastPt,
